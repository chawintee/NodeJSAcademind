...
const stripe = require('stripe')('sk_test_51LTdvPJ6ewSAPnyBo7B02Y35rsXBj0mSGhTkU9k8obUMsQO1JmlT9Rwu2P5PSgpqBxuxpHrN34tnW1g8GwVhXA1N00y0VliLZw')
...
exports.getCheckout = (req,res,next) => {
     ...
     .then(user => {
             ...
             return stripe.checkout.session.create({
                ...
                success_url: `${req.protocal}://${req.get('host')}/checkout/success`, // => http://localhost:3000/checkout/success
